...
models_to_add.append({
    ...
    "category": "NLP",
    "provider": "Ollama",
    "service_url": "http://localhost:11434/api/generate",
...
models_to_add.append({
    ...
    "provider": "本地",
    "command_path": "python",
    "command_args": "-m transformers --model uer/roberta-base-finetuned-chinanews-chinese --task sentiment",
...
models_to_add.append({
    ...
    "provider": "本地",
    "command_path": "python",
    "command_args": "-m speechbrain spkrec-ecapa-voxceleb --source audio.wav",
...
models_to_add.append({
    ...
    "provider": "本地",
    "command_path": "python",
    "command_args": "-m paddlenlp taskflow --task text_classification --model ernie-3.0-base-zh",
...
for model in models_to_add:
    cursor.execute("""
        INSERT OR REPLACE INTO ai_models (
            name, type, category, provider, api_url, api_key_required,
            service_url, command_path, command_args, model_name, description,
    ...
    """, (
        ...
        model["provider"],
        model.get("api_url", ""),
        model.get("api_key_required", False),
        model.get("service_url", ""),
        model.get("command_path", ""),
